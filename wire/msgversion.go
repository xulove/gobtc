...
type MsgVersion struct {
	...
	//在较新版本(Satoshi:0.14.1及以上)Bitcoin客户端实现中，AddrMe不再包含本地的IP和Port，
	// 因为节点可能通过Proxy上网，填入本地的地址没有意义。
	AddrMe NetAddress
	...
	// 当前默认的UserAgent是"/btcwire:0.5.0/"，可以通过AddUserAgent()方法来附加，
	// 如当前btcd实现的UserAgent为“/btcwire:0.5.0/0.12.0”
	UserAgent string
